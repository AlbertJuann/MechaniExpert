...
@section('content')  
    <div class="mt-32 flex flex-wrap justify-center gap-6 p-6 w-4/8">
        <div class="bg-gray-900 p-10 rounded-lg shadow-xl max-w-md flex-1 text-center">
            ...
            <a href="{{ route('edit_profile') }}" class="bg-blue-500 text-white text-lg px-6 py-3 rounded-md mt-4 inline-block hover:bg-blue-600 transition-transform transform hover:scale-110">Edit Profil</a>
